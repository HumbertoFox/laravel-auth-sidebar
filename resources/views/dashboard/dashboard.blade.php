    ...
    <div class="flex flex-1 flex-col-reverse lg:flex-col gap-4 pt-2">
        ...
        <div class="grid auto-rows-min gap-4 md:grid-cols-3">
            @foreach ($cards as $card)
                <a href="{{ $card['href'] }}"
                    class="flex items-center justify-center bg-muted/50 aspect-video rounded-xl border {{ $card['color'] }} hover:border-2 transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:bg-linear-to-br hover:from-muted hover:to-muted/60">
